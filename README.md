...
Como dito no primeiro parágrafo, este quarto projeto é bem simples e resume-se a explicar a utilização do ambiente virtual VENV e implementa um pequeno algoritmo que executar um script externo automaticamente, com o módulo SCHEDULE.
